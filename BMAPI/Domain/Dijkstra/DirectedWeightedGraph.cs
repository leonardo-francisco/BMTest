...
namespace BMAPI.Domain.Dijkstra
{
    public class DirectedWeightedGraph
    {
        ...
        public List<CheapestDistance> FindPaths(String source)
        {
            List<CheapestDistance> cars = new List<CheapestDistance>();
            int d = 0;
            ...
            for (int v = 0; v < n; v++)
            {
                ...
                cars.Add(new CheapestDistance
                {
                    Origem = source,
                    Destino = vertexList[v].name,
                    Distancia = d
                });
            }
